...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/jraph-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=14343&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/jraph-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `jraph` can be installed with:

```
conda install jraph
```

It is possible to list all of the versions of `jraph` available on your platform with:
